...
import { CurriculumManager } from "@/features/curriculum/curriculum-manager";

export default function CurriculumsPage(): React.ReactElement {
  return (
    <Card className="min-h-screen w-full min-w-0 overflow-x-hidden rounded-none bg-transparent py-0 ring-0">
        ...
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4 px-4 sm:px-6">
          <div className="flex min-w-0 items-center gap-4">
            ...
            <ItemContent className="min-w-0">
              ...
              <CardDescription>Curriculums</CardDescription>
            </ItemContent>
          </div>
      ...
      <CardContent className="mx-auto grid w-full min-w-0 max-w-7xl gap-6 px-4 py-8 sm:px-6">
        <Card className="rounded-md border-border bg-card shadow-panel">
          <CardHeader>
            <CardTitle className="text-3xl">Update curriculums</CardTitle>
            <CardDescription>
              Upload and replace the latest INEL/ICOM curriculum PDFs used by the bot.
            </CardDescription>
          </CardHeader>
        </Card>
        <CurriculumManager />
