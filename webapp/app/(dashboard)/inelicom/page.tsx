...
import { ContentManager } from "@/features/inelicom/content-manager";

export default function InelicomPage(): React.ReactElement {
  return (
        ...
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4 px-4 sm:px-6">
          <div className="flex min-w-0 items-center gap-4">
            ...
            <ItemContent className="min-w-0">
              ...
              <CardDescription>INEL/ICOM content</CardDescription>
            </ItemContent>
          </div>
      ...
      <CardContent className="mx-auto grid w-full min-w-0 max-w-7xl gap-6 px-4 py-8 sm:px-6">
        <Card className="rounded-md border-border bg-card shadow-panel">
          <CardHeader>
            ...
            <CardDescription>
              Manage faculties and buildings used by the bot.
            </CardDescription>
          </CardHeader>
        </Card>
        <ContentManager />
