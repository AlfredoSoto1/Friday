...
public class RulesEmbed {
  ...
  public MessageEmbed buildGeneralRules(
      int color,
      String esoRole,
      String botRole,
      String modRole,
    ...
    return new EmbedBuilder()
        ...
        .addField(
            ...
            false)
        .addField(
            "2. :speaking_head:  Cuida tu lenguaje",
            String.format(
                """
        ...
        .addField(
            ...
            false)
        .addField(
            "5. :shield: Cuidado con el contenido que pones",
            """
            **No** contenido obsceno o con restricción de edad. Esto incluye texto, imágenes o
            ...
            false)
        .addField(
            "6. :bangbang: Reportar a un problema",
            String.format(
                """
  ...
  public MessageEmbed buildServerUsageRules(
      int color, String bdeRole, String modRole, String staRole) {
    return new EmbedBuilder()
        .setColor(color)
        ...
        .addField(
            ...
            false)
        .addField(
            "2. :pencil: Conversaciones adicionales",
            String.format(
                """
  ...
  public MessageEmbed buildBotUsageRules(int color, String bdeRole, String esoRole) {
    return new EmbedBuilder()
        ...
        .addField(
            "1. :question: Preguntas a la comunidad",
            """
            ...
            false)
        .addField(
            "2. :question: Qué comandos tiene el Bot?",
            String.format(
                """
