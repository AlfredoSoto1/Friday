...
public final class CommandCatalog {
  ...
  public static InteractionRegistry createDefault(EmbedFactory embedFactory) {
    ...
    interactions.add(new VerificationInteraction(embedFactory));
    interactions.add(new SyncCommand());
    interactions.add(new CoinFlipCommand(embedFactory));
    interactions.add(new LevelingInteraction(embedFactory));
